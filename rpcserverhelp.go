...
var helpDescsEnUS = map[string]string{
	...
	// GetDrawInfoCmd help.
	"getdrawinfo--synopsis":         "Returns staking state and prize structure for the Falcon Draw at the given draw block height.",
	"getdrawinfo-drawheight":        "Draw block height (must be a nonzero multiple of 144)",
	"getdrawinfo--result0":          "JSON object with pool size, tier structure, per-staker jackpot odds, and settlement status",
	"drawstakerinfo-wallethash":     "Staker pubkey hash, hex-encoded",
	"drawstakerinfo-tokens":         "Number of whole-FDRW tokens (one per FDRW staked)",
	"drawstakerinfo-fdrw":           "Total FDRW staked",
	"drawstakerinfo-jackpotodds":    "Jackpot win probability (0.0–1.0)",
	"drawtierinfo-tier":             "Tier number (1 = jackpot)",
	"drawtierinfo-label":            "Tier label (jackpot, tier2, ...)",
	"drawtierinfo-fdrw":             "Prize amount in FDRW",
	"getdrawinforesult-drawheight":       "Draw block height",
	"getdrawinforesult-settlementheight": "Settlement block height (drawheight+1)",
	"getdrawinforesult-settled":          "True if the draw has already been settled",
	"getdrawinforesult-totalpool":        "Total staked FDRW (real wallets + jackpot pool rollover)",
	"getdrawinforesult-realpool":         "FDRW staked by real wallets",
	"getdrawinforesult-jackpotpool":      "Jackpot pool rollover from prior draws",
	"getdrawinforesult-numstakers":       "Number of participating wallets",
	"getdrawinforesult-totaltokens":      "Total whole-FDRW tokens across all real wallets",
	"getdrawinforesult-stakers":          "List of stakers with per-wallet jackpot odds",

	// GetDrawResultCmd help.
	"getdrawresult--synopsis":      "Returns the winner results of a settled Falcon Draw.",
	"getdrawresult-drawheight":     "Draw block height (must be a nonzero multiple of 144)",
	"getdrawresult--result0":       "JSON object with winner list, prize amounts, and rollover info",
	"drawwinnerinfo-wallethash":    "Winner pubkey hash, hex-encoded",
	"drawwinnerinfo-tier":          "Prize tier (1 = jackpot)",
	"drawwinnerinfo-label":         "Tier label (jackpot, tier2, ...)",
	"drawwinnerinfo-prize":         "Prize received in FDRW",
	"getdrawresultresult-drawheight":     "Draw block height",
	"getdrawresultresult-drawnblockhash": "SHA256d hash of the draw block (entropy source)",
	"getdrawresultresult-totalpool":      "Total prize pool in FDRW",
	"getdrawresultresult-jackpotwon":     "True if the jackpot was won; false if it rolled over",
	"getdrawresultresult-rollover":       "Jackpot rollover amount in FDRW (0 if jackpot was won)",
	"getdrawresultresult-numwinners":     "Number of prize winners",
	"getdrawresultresult-winners":        "List of prize winners",
	"getdrawresultresult-settlementtxid": "Settlement transaction ID",

	// GetDrawSizeInfoCmd help.
	"getdrawsizeinfo--synopsis":                  "Returns the estimated settlement block size for the next (or specified) draw, showing growth as wallets stake.",
	"getdrawsizeinfo-drawheight":                 "Optional draw block height; defaults to the next upcoming draw",
	"getdrawsizeinfo--result0":                   "JSON object with UTXO count, wallet count, estimated bytes/weight, and % of limit used",
	"getdrawsizeinforesult-drawheight":            "Target draw block height",
	"getdrawsizeinforesult-blocksuntildraw":       "Blocks remaining until the draw block",
	"getdrawsizeinforesult-numstakingutxos":       "Number of staking UTXOs committed to this draw so far",
	"getdrawsizeinforesult-numwallets":            "Number of unique staking wallets",
	"getdrawsizeinforesult-estsettlementbytes":    "Estimated settlement transaction size in bytes",
	"getdrawsizeinforesult-estsettlementweight":   "Estimated settlement block weight units",
	"getdrawsizeinforesult-maxsettlementweight":   "Maximum allowed settlement block weight",
	"getdrawsizeinforesult-weightusedpct":         "Estimated weight as a percentage of the limit",

	// CreateStakingOutputCmd help.
	"createstakingoutput--synopsis":   "Returns the hex-encoded staking pkScript for a wallet hash and draw height.",
	"createstakingoutput-wallethash":  "20-byte staker pubkey hash, hex-encoded (40 hex chars)",
	"createstakingoutput-drawheight":  "Target draw block height (must be a nonzero multiple of 144)",
	"createstakingoutput--result0":    "Hex-encoded staking pkScript (28 bytes); use as an output script in createrawtransaction",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"getdrawinfo":            {(*btcjson.GetDrawInfoResult)(nil)},
	"getdrawresult":          {(*btcjson.GetDrawResultResult)(nil)},
	"getdrawsizeinfo":        {(*btcjson.GetDrawSizeInfoResult)(nil)},
	"createstakingoutput":    {(*string)(nil)},
