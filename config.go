...
const (
	...
	defaultBlockMaxSize          = 4999000
	defaultBlockMinWeight        = 0
	defaultBlockMaxWeight        = 4996000
...
type config struct {
	...
	GenThreads           int           `long:"genthreads" description:"Number of CPU mining threads (default 1)"`
...
func loadConfig() (*config, []string, error) {
	...
	// disabled.
	if activeNetParams.Params.Net == wire.FalconNet && cfg.DisableStallHandler {
