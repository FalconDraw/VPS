...
const (
	...
	// FalconNet represents the FalconDraw main network. It is distinct
	// from wire.MainNet so that FalconDraw nodes do not handshake with
	// generic Bitcoin network crawlers/nodes scanning port 8333.
	FalconNet BitcoinNet = 0x414570dd
)
